function PHEDServeEnergyViewModel(data) {
    ...
    self.SearchItem = ko.observable(); self.SearchAccountNumber = ko.observable();
    ...
    self.MeterNo = ko.observable(); self.ResidenceType = ko.observable();
    self.StatusOptions = ko.observable();
    self.showAutomatic = ko.observable(); self.showAutomatic2 = ko.observable();
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (data.KYC == null || data.KYC == 'null' || data.KYC == '') {
                    swal('No Record!', 'The Customer Data does not exist on the KYC Database.', 'info');
