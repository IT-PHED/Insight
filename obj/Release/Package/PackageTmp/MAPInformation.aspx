<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MAPInformation.aspx.cs" Inherits="PHEDServe.MAPInformation" %>
...
<div id="AccountDetails" class="inner-page-wrapper blog-single-area"> 
    ...
    <div class="row">
        ...
        <div class="text-holder" id="MapApplicationSuccess" runat="server" style="margin-top:-800px">
                                                        ...
                                                        <td class="content" colspan="2" valign="top" align="center" style="padding-left:90px; padding-right:90px;">
                                                            <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                            <div style="font-size: 22px; line-height: 32px; font-weight: 500; margin-left: 20px; margin-right: 20px; margin-bottom: 25px;">Dear Customer,<span runat="server" id="MAPApplicantsName"></span><b> </b> <span runat="server" id="MeterInformation"></span> </div>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align:center;  padding-bottom: 10px; padding-top: 10px;">
                                                                            <strong><span id="DescriptiveInfo" runat="server"></span> </strong>
                                                                            <br />
                                                                        </td>
                                                                    </tr>
