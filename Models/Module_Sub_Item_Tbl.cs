...
{
    public class Module_Sub_Item_Tbl
    {
        public Module_Sub_Item_Tbl()
        {
            var NewGuid = Guid.NewGuid();
            Module_Sub_Item_ID = NewGuid.ToString();
        }

       
     
        [Key]
        public string Module_Sub_Item_ID { get; set; }
        [ Display (Name = "Module Sub Item")]
